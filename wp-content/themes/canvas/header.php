                ...
                <div id="header-wrap">
                    ...
                    <div class="container clearfix">
                        ...
                        <nav id="primary-menu">
                            ...
                            <ul>
                                <li class="current"><a href="<?= get_site_url() ?>"><div><i class=""></i>Home</div></a>

                                </li>
                                <li><a href="<?= get_site_url() ?>/matches"><div><i class=""></i>Matches</div></a>

                                </li>
                                <li class="mega-menu"><a href="<?= get_site_url() ?>/tournaments"><div><i class=""></i>Tournaments</div></a>

                                </li>
                                <li class="mega-menu"><a href="#"><div><i class=""></i>About</div></a>

                                </li>
                                <li class="mega-menu"><a href="#"><div><i class=""></i>Contact</div></a>								
                                </li>
                                <?php if (empty($userName)): ?>
                                    <li class="mega-menu"><a href="<?= get_site_url() . '/register' ?>"><div><i class=""></i>Login/Register</div></a>								
                                    </li>
                                <?php else: ?>
