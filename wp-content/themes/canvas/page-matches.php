                    ...
                    <table class="table table-bordered nobottommargin">
                        ...
                        <tbody> 
                            ...
                            <tr ng-repeat="matches in getDetails.catPost">
                                ...
                                <td  ng-repeat-end> <input type="text"  ng-if="matches['points_distributed'] == 'No'" class="trade form-control" style="display: {{hideTrade}}" ng-model="$parent.points[teams['team_name']['ID']]" style="width: 100%;" placeholder=" Add Trade"> Your Trade: {{getDetails['tradeTotal'][matches['id']][$index][0]['total']}} <span ng-if="getDetails['tradeTotal'][matches['id']][$index][0]['total'] ==null"> 0</span>
                                ...
                                <td><a href="#" style="display: {{hideTrade}}" onclick="return false" ng-click="tradeMatch(matches['postLink'], matches['id'], points, getDetails.catPost[0]['uid'])" class="btn btn-danger" ng-if="matches['points_distributed'] == 'No'">Trade</a></td>
