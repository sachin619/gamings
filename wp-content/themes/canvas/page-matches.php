                    ...
                    <table class="table table-bordered nobottommargin">
                        ...
                        <tbody> 
                            ...
                            <tr ng-repeat="matches in getDetails.catPost">
                                ...
                                <td  ng-repeat-end> <input type="text" class="trade" style="display: {{hideTrade}}" ng-model="$parent.points[teams['team_name']['ID']]" style="width: 100%;" placeholder=" Add Trade"><br>Your Trade: {{getDetails['tradeTotal'][matches['id']][$index][0]['total']}}
