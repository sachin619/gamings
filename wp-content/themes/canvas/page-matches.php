                    ...
                    <table class="table table-bordered nobottommargin">
                        ...
                        <tbody> 
                            ...
                            <tr ng-repeat="matches in getDetails.catPost">
                                ...
                                <td  ng-repeat-end> <input type="text" ng-model="$parent.points[teams['team_name']['ID']]" width="100%" placeholder="Add Tarde" ><br>Your Trade : {{getDetails['tradeTotal'][matches['id']][$index][0]['total']}}
