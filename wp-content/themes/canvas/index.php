...
<!--                     {{home['upcomingMatches']['catPost']}}-->
                            <tr ng-repeat="matches in homeMatchListing['upcomingMatches']['catPost']">
                                ...
                                <td  ng-repeat-end> <input type="text" ng-model="$parent.points[teams['team_name']['ID']]" style="width: 100%;" placeholder=" Add Tarde" ><br>Your Trade : {{homeMatchListing['upcomingMatches']['tradeTotal'][matches['id']][$index][0]['total']}} </td>
